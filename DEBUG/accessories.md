...
**Line item:** RIDGE  
**Unit:** M  
**Original Excel formula:** `=IF(W117=FALSE,"0",(ACCESSORIES!X10+ACCESSORIES!Z10))`  
**Computed value:** `442`
...
```
QUANTITY!T117 = ROOF!I5 + ACCESSORIES!Z10
= 442
```
"ridgeQuantity": "Roof.buildingOverallLength + Accessories.ridgeQuantityManual"
...
**Line item:** GUTTER  
**Unit:** M  
**Original Excel formula:** `=IF(W118=FALSE,"0",(ACCESSORIES!X5+ACCESSORIES!Z5))`  
**Computed value:** `306`
...
```
QUANTITY!T118 = ROOF!I5 × 2 + ACCESSORIES!Z5
= 306
```
"gutterQuantity": "Roof.buildingOverallLength × 2 + Accessories.gutterQuantityManual",
...
**Line item:** DOWNTAKE  
**Unit:** M  
**Original Excel formula:** `=IF(W119=FALSE,"0",(ACCESSORIES!X6+ACCESSORIES!Z6))`  
**Computed value:** `262.87`
...
| Variable | Excel Cell | Value |
| --- | --- | --- |
| NO. OF MAIN ROOF FRAMES | `ROOF!J9` | `4` |
| NO. OF END ROOF FRAMES | `ROOF!J10` | `2` |
| EAVE HEIGHT (CLADDING Ht.) | `ROOF!J7` | `5.645` |

```
ACCESSORIES!X6 = (ROOF!J9 + ROOF!J10) × ROOF!J7
= 33.87
```
...
```
QUANTITY!T119 = (ROOF!J9 + ROOF!J10) × ROOF!J7 + ACCESSORIES!Z6
= 262.87
```
"downtakeQuantity": "(Roof.mainRoofFrames + Roof.endRoofFrames) × Roof.eaveHeight + Accessories.downTakeQuantityManual",
...
**Line item:** DRIP TRIM  
**Unit:** M  
**Original Excel formula:** `=IF(W120=FALSE,"0",(ACCESSORIES!X7+ACCESSORIES!Z7))`  
**Computed value:** `546`
...
```
ACCESSORIES!X7 = ROOF!I5 × 2 + ROOF!I6 × 2
= 90
```
...
```
QUANTITY!T120 = ROOF!I5 × 2 + ROOF!I6 × 2 + ACCESSORIES!Z7
= 546
```
"dripTrimQuantity": "Roof.buildingOverallLength × 2 + Roof.buildingOverallWidth × 2 + Accessories.dripTrimQuantityManual",

---

# QUANTITY!T121

**Line item:** GABLE END FLASHING  
**Unit:** M  
**Original Excel formula:** `=IF(W121=FALSE,"0",(ACCESSORIES!X8+ACCESSORIES!Z8))`  
**Computed value:** `100.8574470964299`
...
| ROOF EXTENSION | `ROOF!AQ19` | `12` |

```
ACCESSORIES!X8 = (ROOF!I6 / COS(ROOF!J8 × PI() / 180) + 0.14) × 2 + (ROOF!AQ19 / COS(ROOF!J8 × PI() / 180) + 0.14) × 2
= 54.857447096429894
```
...
```
QUANTITY!T121 = (ROOF!I6 / COS(ROOF!J8 × PI() / 180) + 0.14) × 2 + (ROOF!AQ19 / COS(ROOF!J8 × PI() / 180) + 0.14) × 2 + ACCESSORIES!Z8
= 100.8574470964299
```
"gableEndFlashingQuantity": "(Roof.buildingOverallWidth / COS(Roof.roofSlope × PI() / 180) + 0.14) × 2 + (Roof.roofExtensionWidthHeight / COS(Roof.roofSlope × PI() / 180) + 0.14) × 2 + Accessories.gableEndFlashingQuantityManual",

---

# QUANTITY!T122

**Line item:** CORNER FLASH  
**Unit:** M  
**Original Excel formula:** `=IF(W122=FALSE,"0",(ACCESSORIES!X9+ACCESSORIES!Z9))`  
**Computed value:** `33.45749835362376`
...
```
ACCESSORIES!X9 = ROOF!J7 − ROOF!AI6 + ROOF!J7 − ROOF!AQ20 × TAN(ROOF!J8 × PI() / 180) − ROOF!AI9 + ROOF!J7 − ROOF!AI7 + ROOF!J7 − ROOF!AQ20 × TAN(ROOF!J8 × PI() / 180) − ROOF!AI9
= 10.457498353623764
```
...
```
QUANTITY!T122 = ROOF!J7 − ROOF!AI6 + ROOF!J7 − ROOF!AQ20 × TAN(ROOF!J8 × PI() / 180) − ROOF!AI9 + ROOF!J7 − ROOF!AI7 + ROOF!J7 − ROOF!AQ20 × TAN(ROOF!J8 × PI() / 180) − ROOF!AI9 + ACCESSORIES!Z9
= 33.45749835362376
```
"cornerFlashQuantity": "Roof.eaveHeight − enum_SideWallSide:FRONT_Sidewall.height + Roof.eaveHeight − Roof.claddingExtensionWidthHeight × TAN(Roof.roofSlope × PI() / 180) − enum_SideWallSide:LEFT_Sidewall.height + Roof.eaveHeight − enum_SideWallSide:BACK_Sidewall.height + Roof.eaveHeight − Roof.claddingExtensionWidthHeight × TAN(Roof.roofSlope × PI() / 180) − enum_SideWallSide:LEFT_Sidewall.height + Accessories.cornerFlashQuantityManual",
...
**Line item:** ROLLING SHUTTER  
**Unit:** SQM  
**Original Excel formula:** `=IF(W123=FALSE,"0",ACCESSORIES!X12)`  
**Computed value:** `100`
...
| Variable | Excel Cell | Value |
| --- | --- | --- |
| LENGTH | `ACCESSORIES!L12` | `10` |
| WIDTH | `ACCESSORIES!P12` | `10` |
| WIDTH | `ACCESSORIES!T12` | `1` |

```
ACCESSORIES!X12 = ACCESSORIES!L12 × ACCESSORIES!P12 × ACCESSORIES!T12
= 100
```
...
```
QUANTITY!T123 = ACCESSORIES!L12 × ACCESSORIES!P12 × ACCESSORIES!T12
= 100
```
"rollingShutterQuantity": "Accessories.rollingShutterLength × Accessories.rollingShutterWidth × Accessories.rollingShutterNos",
...
**Line item:** LOUVERS  
**Unit:** SQM  
**Original Excel formula:** `=IF(W124=FALSE,"0",ACCESSORIES!X13)`  
**Computed value:** `100`
...
| Variable | Excel Cell | Value |
| --- | --- | --- |
| LENGTH | `ACCESSORIES!L13` | `10` |
| WIDTH | `ACCESSORIES!P13` | `10` |
| WIDTH | `ACCESSORIES!T13` | `1` |

```
ACCESSORIES!X13 = ACCESSORIES!L13 × ACCESSORIES!P13 × ACCESSORIES!T13
= 100
```
...
```
QUANTITY!T124 = ACCESSORIES!L13 × ACCESSORIES!P13 × ACCESSORIES!T13
= 100
```
"louversQuantity": "Accessories.louverLength × Accessories.louverWidth × Accessories.louverQuantity",
...
**Line item:** SKY LIGHT  
**Unit:** SQM  
**Original Excel formula:** `=IF(W125=FALSE,"0",ACCESSORIES!X14)`  
**Computed value:** `100`
...
| Variable | Excel Cell | Value |
| --- | --- | --- |
| LENGTH | `ACCESSORIES!L14` | `10` |
| WIDTH | `ACCESSORIES!P14` | `10` |
| WIDTH | `ACCESSORIES!T14` | `1` |

```
ACCESSORIES!X14 = ACCESSORIES!L14 × ACCESSORIES!P14 × ACCESSORIES!T14
= 100
```
...
```
QUANTITY!T125 = ACCESSORIES!L14 × ACCESSORIES!P14 × ACCESSORIES!T14
= 100
```
"skyLightQuantity": "Accessories.skyLightLength × Accessories.skyLightWidth × Accessories.skyLightQuantity",
...
**Line item:** WALL LIGHT  
**Unit:** SQM  
**Original Excel formula:** `=IF(W126=FALSE,"0",ACCESSORIES!X15)`  
**Computed value:** `100`
...
| Variable | Excel Cell | Value |
| --- | --- | --- |
| LENGTH | `ACCESSORIES!L15` | `10` |
| WIDTH | `ACCESSORIES!P15` | `10` |
| WIDTH | `ACCESSORIES!T15` | `1` |

```
ACCESSORIES!X15 = ACCESSORIES!L15 × ACCESSORIES!P15 × ACCESSORIES!T15
= 100
```
...
```
QUANTITY!T126 = ACCESSORIES!L15 × ACCESSORIES!P15 × ACCESSORIES!T15
= 100
```
"wallLightQuantity": "Accessories.wallLightLength × Accessories.wallLightWidth × Accessories.wallLightQuantity",
