...
import { useUpsertQuantityPebRoof } from '@/api/quotation/quantity/quantity-peb-roof/postQuantityPebRoof'
import { useUpsertQuantityCladding } from '@/api/quotation/quantity/quantity-cladding/postQuantityCladding'
import { useUpsertQuantityCanopy } from '@/api/quotation/quantity/quantity-canopy/postQuantityCanopy'
import { useUpsertQuantityAccessories } from '@/api/quotation/quantity/quantity-accessories/postQuantityAccessories'
import { useUpsertQuantityMezzanine } from '@/api/quotation/quantity/quantity-mezzanine/postQuantityMezzanine'
import { useUpsertQuantityStair } from '@/api/quotation/quantity/quantity-stair/postQuantityStair'
import { useUpsertQuantityAdditionalBolts } from '@/api/quotation/quantity/quantity-additional-bolts/postQuantityAdditionalBolts'
