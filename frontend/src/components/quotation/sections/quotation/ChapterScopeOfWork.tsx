...
function getBuildingDescription({ projectInfo, roof, accessories, canopy, mezzanine, stair }: QuotationDraftSlices): readonly Row[] {
  ...
  return [
    ...
    ['D', 'Gable Trim', yesOrNa(Number(accessories.gableEndFlashingQuantity) > 0)],
    ['E', 'Corner Flash', yesOrNa(Number(accessories.cornerFlashQuantity) > 0)],
    ['F', 'Ridge Sheet', yesOrNa(Number(accessories.ridgeQuantity) > 0)],
