 ...
 * "A-1", "FB-4"); {@link classify} derives the store group + enum jointId so a
...
function classify(label: string): { group: DiagramGroup; jointId: string } {
  ...
  return { group: 'roof', jointId: up.replace('-', '_') }
}
...
const mainTwoStorey: FrameDiagram = {
  ...
  nodes: [
    // Roof
    n(40, 150, 'C'), n(70, 141, 'I'), n(180, 106, 'B-1'), n(175, 107, 'L'),
    n(340, 55, 'A'), n(500, 106, 'B-1'), n(505, 107, 'L'), n(640, 150, 'C'), n(610, 141, 'D'),
    ...
    // Foundation
    n(40, 330, 'FB-3'), n(175, 330, 'FB-1'), n(340, 330, 'FB-2'), n(505, 330, 'FB-2'), n(640, 330, 'FB-1'),
  ],
}
...
const mainMezzanine: FrameDiagram = {
  ...
  nodes: [
    n(40, 120, 'C'), n(70, 112, 'I'), n(180, 78, 'B-1'), n(175, 82, 'L'),
    n(340, 45, 'A'), n(500, 78, 'B-1'), n(505, 82, 'L'), n(640, 120, 'C'), n(610, 112, 'D'),
...
const endFrame: FrameDiagram = {
  id: 'end-frame',
  title: 'End Frame',
  caption: 'Gable end frame with A-1/B-2/C-1 suffixed joint codes.',
  viewBox: '0 0 680 260',
  edges: [
    e(40, 120, 340, 45), e(340, 45, 640, 120),
  ...
  nodes: [
    n(40, 120, 'H-1'), n(70, 112, 'I-1'), n(100, 104, 'C-1'), n(190, 78, 'B-2'),
    n(258, 63, 'L-1'), n(340, 45, 'A-1'), n(422, 63, 'L-1'), n(490, 78, 'B-2'),
    n(610, 104, 'C-1'), n(640, 120, 'D-1'),
    n(175, 100, 'D-1'), n(505, 100, 'D-1'), n(258, 100, 'K-1'), n(422, 100, 'K-1'),
    n(40, 150, 'G-1'),
